...
import com.cameroon.banner.listener.OnBannerClickListener;
import com.cameroon.banner.listener.OnBannerListener;
import com.cameroon.banner.loader.ImageLoaderInterface;
import com.cameroon.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void initView(Context context, AttributeSet attrs) {
        imageViews.clear();
        Arthur.getInstance().start(context);
